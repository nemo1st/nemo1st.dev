...
const SHORTS = [
  {
    title: "こだわった方が、作業しやすい。",
    date: "2026-09-09",
    body: "カフェで作業する以外にも、自分が集中しやすい環境ってなんだろうと考えた。たとえばキーボード。自分には、できるだけ無刻印のものが合っている。目に入る情報が少ない方が、目の前の作業に集中しやすい。タスクを減らして、意識を向ける先も減らしていく。あとは作業するだけ、という状況をつくる。もっと頑張るために、まずは環境にこだわってみる。",
  },
  {
